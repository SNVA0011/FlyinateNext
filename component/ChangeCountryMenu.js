        ...
        <DropdownButton title={<>
            ...
            <div className='curr-block py-4'>
                ...
                <Row>
                    ...
                    <Col xs="6">
                        <Dropdown.Item  locale="es" onClick={(e) => { setLang('ES') }} href={'/es/'} className={'btn btn-site ripple-effbtn btn-40 btn-block text-center ' + (lang === 'ES' ? 'active' : '')}><span>Spanish</span></Dropdown.Item>
                    </Col>
                </Row>
            </div>
