    ...
    <div className='popular-destination full-w'>
                <Container>
                    ...
                    <Row>
                        ...
                        <Col xs={12} md={6} lg={4}>
                            <Link href="/es/galapagos-islands-flyinate">
                            <a className='image_area_partition'> 
                        ...
                        <Col xs={12} md={6} lg={4}>
                            ...
                            <Link href="/es/easter-island-flyinate">
                            <a className='image_area_partition'> 
                        ...
                        <Col xs={12} md={6} lg={4}>
                            <Link href="/es/buenos-aires-flyinat">
                            <a className='image_area_partition'> 
