...
export const getServerSideProps = async (ctx) => {
  ...
  //========== English (en) ==========
  const staticUrl = [
    {'url':'','time':'2022-04-30T04:40:48.000Z'},
    {'url':"about-us",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"flights",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"contact",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"privacy",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"terms",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"cheap-flights/machu-picchu-flyinate",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"cheap-flights/galapagos-islands-flyinate",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"cheap-flights/cusco-flyinate",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"cheap-flights/easter-island-flyinate",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"cheap-flights/buenos-aires-flyinat",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"cheap-flights/lima-flyinate",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"customize/business-travel",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"customize/group-travel",'time':'2022-04-30T04:40:48.000Z'},
    {'url':'blog','time':new Date().toISOString()}
  ]
  // staticUrl
  const staticSitemaps = staticUrl.map((item) => ({
    loc: `${baseUrl}/${item.url.replace('&', '&amp;')}`,
    lastmod: new Date(item.time).toISOString(),
  }));
  // blog
  const blogSitemaps = posts && posts.map((item) => ({
    loc: `${baseUrl}/blog/${item.titleUrl.replace('&', '&amp;')}`,
    lastmod: new Date(item.posttime).toISOString(),
  }));
  ...
  const flightsSitemaps = flightsposts && flightsposts.filter((items) => items.pageType === "Airline").map((items) => ({
    ...
    lastmod: '2022-04-30T04:40:48.000Z',
  }));
 ...
 let esFlightsposts = await getJsonbyPost("https://cms.travomint.com/travoles-content/site-map?authcode=Trav3103s987876",JSON.stringify({
  ...
  const esStaticUrl = [
    {'url':'','time':'2022-04-30T04:40:48.000Z'},
    {'url':"sobre-nosotras",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"vuelos",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"articulos",'time':new Date().toISOString()},
    {'url':"contacto",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"politica",'time':'2022-04-30T04:40:48.000Z'},
    {'url':"terminos",'time':'2022-04-30T04:40:48.000Z'}
  ]
  // esStaticUrl
